											...
											<li id="bookmark_<?php echo $job_id; ?>">
												...
												<div class="job-listing">
													...
													<div class="buttons-to-right">
														<a href="#delete-dialog<?php echo $job_id; ?>" class="button red ripple-effect ico popup-with-zoom-anim" title="Remove" data-tippy-placement="left">
															<i class="icon-feather-trash-2"></i>
														</a>
													</div>
													<!-- Delete BookMark popup -->
													<div id="delete-dialog<?php echo $job_id; ?>" class="zoom-anim-dialog mfp-hide dialog-with-tabs">

														<!--Tabs -->
														<div class="sign-in-form">

															<ul class="popup-tabs-nav">
																<li><a href="#tab<?php echo $job_id; ?>">Delete Bookmark</a></li>
															</ul>

															<div class="popup-tabs-container">

																<!-- Tab -->
																<div class="popup-tab-content" id="tab<?php echo $job_id; ?>">

																	<!-- Welcome Text -->
																	<div class="welcome-text">
																		<h4>Are you sure you want to delete your job Bookmark?</h4>
																	</div>

																	<a href="#" data-job_id="<?php echo $job_id; ?>" class="button full-width red ripple-effect ico bookmark-remove" title="Remove">
																		Yes Delete <i data-job_id="<?php echo $job_id; ?>" class="icon-feather-trash-2"></i>
																	</a>
