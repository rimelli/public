		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner-headline">
					<h3>
						<strong>THE #1 ALL IN ONE PLATFORM FOR SPORTS</strong>
						<br>
						<span>Find <strong class="color">Trials, Players, Jobs. </strong>Build your <strong class="color">Network </strong>and promote <strong class="color">Yourself.</strong></span>
					</h3>
				</div>
				<br>
				<a href="register.php" class="button big ripple-effect">Register</a>
				<a href="#" class="button big gray ripple-effect-dark">Learn More</a>
			</div>
		</div>
			...
			<div class="col-md-12">
				<ul class="intro-stats margin-top-45">
					...
					<li>
						...
						<span>Scouts, Coaches, Trainers, Agents</span>
					</li>
					<li>
						<strong>Organisations</strong>
						<span>Clubs, Academies, Companies</span>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-1.html" class="photo-box" data-background-image="assets/images/players.jpg">
					<div class="photo-box-content">
						<h3>Players</h3>
						<span>Find Trials</span>
						<span>Apply for Clubs</span>
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-full-page-map.html" class="photo-box" data-background-image="assets/images/professionals.jpg">
					<div class="photo-box-content">
						<h3>Professionals</h3>
						<span>Find Jobs</span>
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-grid-layout-full-page.html" class="photo-box" data-background-image="assets/images/organi.jpg">
					<div class="photo-box-content">
						<h3>Organisations</h3>
						<span>Find Players</span>
						<span>Hire Professionals</span>
						<span>Promote Your Organisation</span>
					</div>
				</a>
			</div>
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-2.html" class="photo-box" data-background-image="assets/images/other.jpg">
					<div class="photo-box-content">
						<h3>Other</h3>
						<span>Fans</span>
						<span>Parents</span>
...
<div id="footer">
	...
	<div class="footer-bottom-section">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
					© 2020 <strong>Tryouts</strong>. All Rights Reserved.
				</div>
			</div>
		</div>
	</div>
	...
	<div class="sign-in-form">
		...
		<div class="popup-tabs-container">
			...
			<div class="popup-tab-content" id="login">
				...
				<!-- Button -->
				<button class="button full-width button-sliding-icon ripple-effect" type="submit" name="login_button" form="login-form">Log In <i class="icon-material-outline-arrow-right-alt"></i></button>
