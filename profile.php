													...
													<form action="<?php echo $username; ?>" method="POST">
													 			...
													 			if($userLoggedIn != $user_id) {
													 				...
													 				if($logged_in_user_obj->isFollowing($user_id)) {
													 					echo '<button type="submit" name="remove_following" class="following-btn margin-left-10"><a class="button ripple-effect"><i class="icon-feather-user-check"></i> Following</a></button>';
													 				}
													 				else
													 					echo '<button type="submit" name="add_following" class="follow-btn margin-left-10"><a class="button ripple-effect"><i class="icon-feather-user"></i> Follow</a></button>';
													 			} ?>
												 			</form>
												</div>
                    </div>
